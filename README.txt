...
- **Explosions**: Area damage effects from bombs and bazooka rounds with animated sprite effects.
...
- **Projectile.cpp**: Implements bullet physics, collision detection, and automatic collision registration.
